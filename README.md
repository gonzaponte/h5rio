...
- Write-time shape validation for appended arrays.
...
Every appended array must have exactly the configured `item_shape`; mismatched
array shapes are rejected before the writer buffers the value.
